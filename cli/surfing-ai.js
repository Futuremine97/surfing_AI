...
const PASSTHROUGH = new Set([
  ...
  "desktop", "max-procs", "threads", "fleet", "bg", "cowork",
]);
...
usage:
  ...
  surfing-ai cowork start "<goal>" long-running, proactive agentic mode
  surfing-ai cowork run -s <id> --watch    advance / monitor the mission
